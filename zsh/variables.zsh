...
export PATH=$HOME/.local/bin:$HOME/.local/bin:$HOME/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/sbin:/usr/sbin:/sbin:/usr/bin/core_perl:$HOME/.rvm/bin:/usr/local/texlive/2015/bin/x86_64-darwin:$PATH
